...
@InputType()
class ServiceStatusCreateNestedManyWithoutServiceMonitorsInput {
...
export { ServiceStatusCreateNestedManyWithoutServiceMonitorsInput as ServiceStatusCreateNestedManyWithoutServiceMonitorsInput };
